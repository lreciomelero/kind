...
Como prerrequisito de la instalación se debe indicar un repositorio de helm del que se pueda extraer el chart de _Cluster Operator_. Este repositorio puede utilizar protocolo https u oci (utilizado para repositorios de _cloud providers_ como ECR, GAR o ACR).
...
NOTE: Verificar en la documentación de keos-installer los repositorios que se soporten en la versión a utilizar.