...
Como prerrequisito de la instalación se debe indicar un repositorio de helm del que se pueda extraer el chart de _Cluster Operator_. Este chart de helm puede ser un repositorio de helm tradicional o de tipo OCI, el cual es soportado para ECR.  
